...
%>
                  <tr>
                    <td class="left_bg"><table width="70%" height="27" border="0" align="right" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="80%" align="right"><a href="newsList.asp?classid=<%=rs("id")%>" class="main_title"><%=rs("classname_cn")%></a></td>
...
%>
<li>
<a href="newsView.asp?id=<%=rs("proid")%>" title="<%=rs("proname_cn")%>" target="_blank"><%=limitTitle(rs("proname_cn"),20)%></a>
