...
<head>
	...
	<script src="js/newsClass.js" type="text/javascript"></script><!--本页专有JS-->
...
<table width="97%" align="center" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="45" valign="bottom" bgcolor="#C7DAE9"><table border="0" align="right" cellpadding="0" cellspacing="0">
      <tr>
        <td>&nbsp;</td>
        <td width="80" height="25" bgcolor="#838383" align="center" class="white"><a href="newsList.asp">新闻管理</a></td>
        <td width="10">&nbsp;</td>
        <td width="80" bgcolor="#838383" align="center" class="white"><a href="newsAdd.asp">新闻添加</a></td>
        <td width="10">&nbsp;</td>
        <td width="80" bgcolor="#FF6600" align="center" class="white"><a href="newsClass.asp"><b>类别管理</b></a></td>
        <td width="10">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  ...
  <tr>
    <td height="500" valign="top" bordercolor="#DAEBEF" bgcolor="#FFFFFF"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form action="newsClassAdd.asp" method="POST" name="classForm1">
		<tr>
...
sql="select * from newsclass order by classcode"
...
%>
          ...
          <tr>
			...
			<div align="center">
			<a class="ajaxOrder" href="newsClassOrder.asp?action=up&classId=<%=classId%>"><u>↑</u></a>
			&nbsp;|&nbsp;
			<a class="ajaxOrder" href="newsClassOrder.asp?action=down&classId=<%=classId%>"><u>↓</u></a>
            </div>
			</td>
            <td width="34%"><%=classLevelFix%><%=classNameCn%></td>
            <td width="30%"><%=classLevelFix%><%=classNameEn%></td>
            <td><div align="center">
			<a href="newsClassEdit.asp?classId=<%=classId%>&height=220&width=340" class="thickbox" title="<strong>修改分类信息</strong>">
			<img src="images/edit.gif" width="22" height="22" />
			</a>
			</div></td>
            <td><div align="center">
			<a href="newsClassDel.asp?classId=<%=classId%>" onclick="return confirm('确定删除吗?')">
