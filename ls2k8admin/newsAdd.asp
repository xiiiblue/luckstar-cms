...
<head>
	...
	<script src="js/newsAdd.js" type="text/javascript"></script><!--本页专有JS-->
</head>
<body>
<!--header开始-->
  ...
  <tr>
    <td height="500" valign="top" bordercolor="#DAEBEF" bgcolor="#FFFFFF"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form name="form1" action="newsAddDo.asp" method="post" enctype="multipart/form-data">
          <tr height="25">
...
&nbsp;无&nbsp;</label>
				<a href="#" id="openParameter"><img src="images/div_add.gif" border="0" name="openericon"></a>
			</td>
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="cn">
                <td><textarea name="proparameter_cn" id="proparameter_cn" cols="48" rows="3">互联网</textarea></td>
              </tr>
              <tr>
                <td></td>
              </tr>
              <tr class="en">
                <td><textarea name="proparameter_en" id="proparameter_en" cols="48" rows="3">Internet</textarea></td>
              </tr>
            </table>
			</div>
			</td>
            <td>
			<div class="red" id="proparameter_cn_err" style="display:none;">您还没有输入中文来源！√</div>
			<div class="green" id="proparameter_cn_tip" style="display:none;"></div>
			<div class="red" id="proparameter_en_err" style="display:none;">您还没有输入英文来源！√</div>
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="cn">
                <td><textarea id="prooutline_cn" name="prooutline_cn" cols="48" rows="3">做网站,网站建设,济南,山东,阿科斯达,Google</textarea></td>
              </tr>
              <tr>
                <td></td>
              </tr>
              <tr class="en">
                <td><textarea id="prooutline_en" name="prooutline_en" cols="48" rows="3">LuckStar</textarea></td>
              </tr>
            </table>
			</div>
			</td>
            <td class="red">
			<div class="red" id="prooutline_cn_err" style="display:none;">您还没有输入中文关键词！√</div>
			<div class="green" id="prooutline_cn_tip" style="display:none;"></div>
			<div class="red" id="prooutline_en_err" style="display:none;">您还没有输入英文关键词！√</div>
...
oFCKeditor.Height	= 150 ;
oFCKeditor.ToolbarSet = "Basic"; 
oFCKeditor.Value	= 'enter news content here...' ;
oFCKeditor.Create() ;
//-->
</script>
<%end if%>
