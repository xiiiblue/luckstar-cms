...
if action = "edit" and proid <> 0 then
	...
	dim proprice:proprice = rs("proprice")
	rs.close
end if
%>
...
<head>
	...
	<script src="js/productsEdit.js" type="text/javascript"></script><!--本页专有JS-->
</head>
  ...
  <tr>
    <td height="500" valign="top" bordercolor="#DAEBEF" bgcolor="#FFFFFF"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
		<!--表单开始-->
		<table width="700" border="0" align="center" cellpadding="2" cellspacing="2" class="classList">
		<form name="form1" action="productsEditDo.asp" method="post" enctype="multipart/form-data">
...
<span class="green">备注：此选项对应有复杂参数的产品！<a href="#" id="openParameter"><img src="images/div_add.gif" border="0" name="openericon"></a></span></td>
          ...
          <tr>
            ...
            <td>
			<span class="red" id="proparameter_cn_err" style="display:none;">您还没有输入中文型号！√</span>
			<span class="red" id="proparameter_en_err" style="display:none;">您还没有输入英文型号！√</span>			</td>
          </tr>
          <tr height="25">
          ...
          <tr>
            ...
            <td class="red">
			<span class="red" id="prooutline_cn_err" style="display:none;">您还没有输入中文描述！√</span>
			<span class="red" id="prooutline_en_err" style="display:none;">您还没有输入英文描述！√</span>
			</td>
          </tr>
          <tr height="25">
			...
			<a href="productsPicAdd.asp?action=single&keepThis=true&TB_iframe=true&height=300&width=300" title="单张图片上传" class="thickbox" id="jumpIframe1">单图片上传伪链接</a>
			<a href="productsPicAdd.asp?action=multi&keepThis=true&TB_iframe=true&height=300&width=300" title="多张图片上传" class="thickbox" id="jumpIframe2">多图片上传伪链接</a>
			</div>
			</td>
          ...
          <tr>
			...
			<div id = "picList" style="display:none;">
				...
				<div class="addNewPic">
					<div class="intro">加入新图片</div>
					<input type="file" class="multi" accept="gif|jpg" maxlength="5"/>
				</div>
			</div>
			</td>
            <td></td>
          ...
          <tr height="25">
            <td align="right" bgcolor="#F6F6F6"><b>排序：</b></td>
            <td bgcolor="#F6F6F6">
          ...
          <tr height="25">
            ...
            <td bgcolor="#F6F6F6">
              <input name="proprice" type="text" value="<%=proprice%>" maxlength="6" size="50" class="suSlider" minvalue="0" maxvalue="10000" stepvalue="10"  />
            </td>
            <td bgcolor="#F6F6F6">&nbsp;</td>
          </tr>
          <tr height="25" class="cn">
