...
if CookieUserName=empty then error("您还未<a href=""userLogin.asp"">登录</a>")
...
<SCRIPT type="text/javascript" src="bbs/Utility/calendar.js"></SCRIPT>
...
%>
<form method="POST" name="form" action="userProfile.asp">
<input type=hidden name=menu value="editProfileok">
<table width=380 align="center" cellpadding=3 cellspacing=1 class="PannelBody" id="Pannel0" style="display:">
	<tr>
      <td width="79" align="center"><b>名字</b></td>
      <td width="299"><input type="text" name="RealName" size="20" value="<%=Rs("RealName")%>"></td>
    </tr>
...
<%end if%>
	<tr>
    	<td width="79" align="center"><b>性别</b>		</td>
...
<div style="padding-top:5px; text-align:center;"><input type="submit" value=" 确 定 "></div>
</form>
...
Sub editProfileok
	...
	Message=Message&"<li>修改资料成功</li><li><a href=userProfile.asp?UserName="&CookieUserName&">查看我的资料</a></li>"
	succeed Message,"userProfile.asp?UserName="&CookieUserName&""
...
Sub pass
	...
	Set Rs=Execute(sql)
%>
<form method="POST" name="form"action="userProfile.asp" onSubmit="return VerifyInput();">
<table width=380 align="center" cellpadding=5 cellspacing=1 id=CommonListArea>
	...
	<tr id=CommonListCell>
	    <td align="right" width="45%"><b>重输新密码：</b></td>
