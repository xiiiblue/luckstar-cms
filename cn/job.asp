	...
	<table width="747" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" class="right"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><span class="blue_02">■</span>&nbsp;当前位置 :<a href="index.asp">网站首页</a> &gt; 招聘信息</td>
            </tr>
            <tr>
              <td>
<%
...
function showProList(rs,iPageSize)
	...
	if not (rs.eof and rs.bof) then
		...
		do while not rs.eof
			i = i + 1
%>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="3" style="margin-top:4px;">
  <tr>
    <td width="78" bordercolor="#C7DAE9"><div align="right"><strong>职位名称:</strong></div></td>
    <td width="322" bordercolor="#C7DAE9"><%=rs("jobname_cn")%></td>
    <td width="86" bordercolor="#C7DAE9"><div align="right"><strong>招聘人数:</strong></div></td>
    <td width="265" bordercolor="#C7DAE9"><%=rs("jobnumber")%></td>
  </tr>
  <tr>
    <td bordercolor="#C7DAE9">&nbsp;</td>
    <td bordercolor="#C7DAE9"><a href="#" class="viewMore">查看更多</a>(图标)</td>
    <td colspan="2" bordercolor="#C7DAE9"><a href="jobApply.asp?jobid=<%=rs("jobid")%>&keepThis=true&TB_iframe=true&height=400&width=500" class="thickbox">应聘此职位</a>(图标)</td>
  </tr>
</table>
  <div style="display:none;" class="applyContent">
  <table width="100%" border="1" align="center" cellpadding="3" cellspacing="3">
  <tr>
    <td bordercolor="#A4D3FF"><div align="right"><strong>工作地点:</strong></div></td>
    <td bordercolor="#A4D3FF"><%=rs("jobaddress_cn")%></td>
    <td bordercolor="#A4D3FF"><div align="right"><strong>薪资:</strong></div></td>
    <td bordercolor="#A4D3FF"><%=rs("jobpay")%></td>
  </tr>
  <tr>
    <td bordercolor="#A4D3FF"><div align="right"><strong>结束时间:</strong></div></td>
    <td bordercolor="#A4D3FF"><%=rs("jobdate")%></td>
    <td bordercolor="#A4D3FF"><div align="right"><strong>职位状态:</strong></div></td>
    <td bordercolor="#A4D3FF"><%=rs("jobstate")%></td>
  </tr>
  <tr>
    <td bordercolor="#A4D3FF"><div align="right"><strong>要求:</strong></div></td>
    <td colspan="3" bordercolor="#A4D3FF">
	<%=rs("jobduties_cn")%>
	</td>
  </tr>
  <tr>
    <td bordercolor="#A4D3FF"><div align="right"><strong>详情:</strong></div></td>
    <td colspan="3" bordercolor="#A4D3FF">
	<%=rs("jobcontent_cn")%>
	</td>
  </tr>
