...
<script type="text/javascript" src="bbs/Utility/global.js"></script>
<script type="text/javascript" src="bbbs/Utility/BBSXP_Modal.js"></script>
<script type="text/javascript" src="bbs/Themes/default/Common.js"></script>
<script type="text/javascript" src="bbs/Utility/Pswdplc.js"></script>
</head>
...
<table cellspacing=1 cellpadding=5 width=100% id=CommonListArea>
	<tr id=CommonListTitle>
		<td colspan="2" valign="middle" align="center"><strong>注册用户资料</strong></td>
	</tr>
	<tr id=CommonListCell>
		<td align="right" width="23%"><b>用户名：</b></td>
	  <td align="Left" width="77%"><input type="text" name="UserName" size="40" onBlur="CheckUserName(this.value)" class="regText"> <div id="CheckUserName" style="color:#FF0000"></div></td>
	</tr>
<%	if SiteConfig("AccountActivation")<>1 then%>
	<tr id=CommonListCell>
		<td align="right" valign="middle" width="23%"><b>密码：</b><br>
	  (至少6个字符)</td>
	  <td align="Left" valign="middle" width="77%"><input type="password" name="password" size="40" maxLength="16" onkeyup=EvalPwd(this.value); onchange=EvalPwd(this.value); onBlur="CheckUserPass(this.value)" class="regText"> <div id="CheckUserPass" style="color:#FF0000"></div></td>
	</tr>
	<tr id=CommonListCell>
	...
	<tr id=CommonListCell>
		<td align="right" valign="middle" width="23%"><b>重新键入密码：</b></td>
		<td align="Left" valign="middle" width="77%"><input type="password" name="RetypePassword" size="40" onBlur="CheckRetypePassword(this.value)" class="regText"> <div id="CheckRetypePassword" style="color:#FF0000"></div></td>
	</tr>
<%	end if%>
	<tr id=CommonListCell>
		<td align="right" valign="middle" width="23%"><b>Email地址：</b><br><%if SiteConfig("AccountActivation")=1 then%><font color="FF0000">密码将通过Email发送</font><%end if%></td>
	 	<td align="Left" valign="middle" width="77%">
		<input type="text" name="UserEmail" size="40" onBlur="CheckMail(this.value)" <%if SiteConfig("AccountActivation")=2 then%> value="<%=UserEmail%>" readonly<%end if%> class="regText"> <div id="CheckMail" style="color:#FF0000"></div></td>
	</tr>
...
function CheckUserName(UserName) {
	...
	Ajax_CallBack(false,"CheckUserName","bbs/Loading.asp?menu=CheckUserName&UserNameLength="+UserName.length+"&UserName=" + escape(UserName));
}
...
function CheckMail(Mail) {
	...
	Ajax_CallBack(false,"CheckMail","bbs/Loading.asp?menu=CheckMail&Mail=" + Mail);
}
</script>
<%
end if
