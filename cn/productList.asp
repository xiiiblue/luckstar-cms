	...
	<table width="747" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" class="right"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><span class="blue_02">■</span>&nbsp;当前位置 :<a href="index.asp">网站首页</a> &gt; 系统展示</td>
            </tr>
            <tr>
              <td>
<%
...
%>
			 	 <table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					  ...
					  <!--这里取图片用到了func.asp里的函数,用缩略图,加前缀min_即可-->
					  <a href="uploadPic/<%=getPic("productpic",rs("proid"),1)%>" class="thickbox">
					  <img src="uploadPic/<%=getPic("productpic",rs("proid"),1)%>" width="70" height="70" />
					  </a>
					  
					  </td>
					  <td width="550" height="50" valign="top">
					  <a href="productView.asp?id=<%=rs("proid")%>" target="_blank">
					  <font class="main_title"><%=rs("proname_cn")%></font>
					  </a>
					  <br />
					  <%=limitTitle(rs("prointro_cn"),60)%>
					  </td>
					</tr>
					...
					<tr>
					  <td height="13">	  
	  <div class="detailA" style="display:none;">
		<%=rs("prooutline_cn")%>
	  </div>		  	  
	  <div class="detailB" style="display:none;">
		<%=rs("proparameter_cn")%>
	  </div>
					  </td>
					</tr>
