...
<DIV id="CommonHeader">
<iframe width="960" height="230" frameborder="0" scrolling="no" src="../bbsheader.asp"></iframe>
<DIV id=CommonTop>
...
%>
	...
	<iframe width="960" height="80" frameborder="0" scrolling="no" src="../bbsfooter.asp"></iframe>
</div>
