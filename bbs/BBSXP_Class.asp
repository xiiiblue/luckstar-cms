...
MailBody=MailBody&"<br><br><br><a target=_blank href="&SiteConfig("SiteUrl")&"/Default.asp>"&SiteConfig("SiteName")&"</a> 管理团队<br><br><a target=_blank href=http://www.bbsxp.com>BBSXP</a>  &copy; 2007-"&year(now)&" <a target=_blank href=http://http://www.luck-star.com>LuckStar</a>"
